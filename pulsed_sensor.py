...
def get_sample(CONFIG, is_new_data_send, is_new_data_save, counter, sample):
    ...
    while True:
        ...
        print("Time measure: " + datetime.strftime(now, '%Y-%m-%d %H:%M:%S'))
...
if __name__ == "__main__":
    ...
    monitor_ps = multiprocessing.Process(
    ...
    sample_ps = multiprocessing.Process(
                                        target=get_sample,
                                        args=(
                                            CONFIG,
                                            is_new_data_send,
    ...
    database_ps = multiprocessing.Process(
    ...
    save_local_ps = multiprocessing.Process(
                                            target=save_in_local_storage,
                                            args=(
                                                PATH,
                                                DATABASE['table_name'],
                                                is_new_data_save,
